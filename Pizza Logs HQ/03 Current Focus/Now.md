...
| Spot-check gear slot/GearScore fix | VERIFY | After deploy, confirm `/players/Lausudo` shows the libram as `Ranged` and full 2H+relic GearScore; confirm `/players/Aalaska` shows staff/wand in the weapon row |
